	...
	def _find_installed_browser_path(channel: BrowserChannel | None = None) -> str | None:
		...
		if system == 'Darwin':  # macOS
			...
			all_patterns = [
				...
				('chromium', f'{playwright_path}/chromium-*/chrome-mac*/Google Chrome for Testing.app/Contents/MacOS/Google Chrome for Testing'),
				...
				('chromium', f'{playwright_path}/chromium_headless_shell-*/chrome-mac/Google Chrome for Testing.app/Contents/MacOS/Google Chrome for Testing'),
			]
		elif system == 'Linux':
			if not playwright_path:
