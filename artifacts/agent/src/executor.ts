...
- On news/listing pages (e.g. Hacker News, Reddit), story titles are descriptive links with actual words. Links marked "(source domain)" are just the source website — do NOT click them to open a story. Timestamps and comment counts have been filtered out.
