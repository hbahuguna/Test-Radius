...
function statusBadge(status: string) {
  if (status === "passed") return <Badge className="bg-green-500/15 text-green-500 border-green-500/30">PASS</Badge>;
  if (status === "failed") return <Badge className="bg-red-500/15 text-red-500 border-red-500/30">FAIL</Badge>;
